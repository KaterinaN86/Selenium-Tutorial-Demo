...
public class AlertsTests extends TestUtilities {
    ...
    public void jsDismissTest() {
        ...
        // 2 - Result text is expected
        softAssert.assertEquals(result, "You clicked: Cancel", "result is not expected. \nShould be 'You clicked: Cancel', but it is '" + result + "'");
        softAssert.assertAll();
    }
    ...
    public void jsPromptTest() {
        ...
        // 2 - Result text is expected
        softAssert.assertEquals(result, "You entered: Hello Alert, it's Dmitry here", "result is not expected. \nShould be 'You entered: Hello Alert, it's Dmitry here', but it is '" + result
                + "'");
        softAssert.assertAll();
    }
}
