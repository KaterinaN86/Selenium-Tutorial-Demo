...
public class BasePageObject {
    ...
    public void switchToWindowWithTitle(String expectedTitle) {
        ...
        //Handle for the first opened window (the one we are currently on).
        String firstWindow = driver.getWindowHandle();
        //List od handles for all opened windows.
        ...
        while (windowsIterator.hasNext()) {
            ...
            if (!windowHandle.equals(firstWindow)) {
                //If the handle is not equal to the one of the currently opened window, we switch driver to that window.
                driver.switchTo().window(windowHandle);
                //When we find the one whose page title matches expected, the cycle can end.
